...
#                        pkg_repl("glite-yaim-torque-server","5.0.0-1.sl5","noarch");
#                         pkg_repl("glite-yaim-torque-utils","5.0.0-1.sl5","noarch");
...
'/software/packages'= {
  pkg_repl("lcg-info-dynamic-scheduler-pbs","2.3.0-1.sl5","noarch");
