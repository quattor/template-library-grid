unique template common/gip/voms;
...
'provider/glite-info-service-voms'=format(file_contents('common/gip/files/provider.voms'),
  FULL_HOSTNAME,
  "/etc/bdii/gip/",
  SITE_NAME,
);

'provider/glite-info-service-voms-admin'=format(file_contents('common/gip/files/provider.voms-admin'),
  FULL_HOSTNAME,
  "/etc/bdii/gip/",
  SITE_NAME,
);
