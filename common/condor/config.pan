...
variable CONDOR_CONFIG_CONTENTS = file_contents('common/condor/templ/condor_config.templ');
variable CONDOR_CONFIG_CONTENTS = replace('<%LOCAL_DIR%>',CONDOR_VAR_DIR,CONDOR_CONFIG_CONTENTS);
variable CONDOR_LOCAL_CONFIG_CONTENTS = file_contents('common/condor/templ/condor_config.local.templ');
