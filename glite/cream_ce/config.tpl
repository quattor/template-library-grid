...
template glite/cream_ce/config;
...
include { 'common/tomcat5/functions' };
...
include { 'common/blparser/blah-config' };

#-----------------------------------------------------------------------------
# Configuration for GLEXEC.
#-----------------------------------------------------------------------------
include { 'common/glexec/cream_ce/config' };
...
include { 'glite/cream_ce/upgrade_db' };
...
variable CREAM_CE_CONFIG_CONTENTS=file_contents('glite/cream_ce/templates/cream-config.templ');
...
include { if ( CEMON_ENABLED ) 'glite/cream_ce/cemonitor' };
...
#------------------------------------------------------------------------------
# Configure the Catalina service for ce-cream
#------------------------------------------------------------------------------
variable CATALINA_CE_CREAM_CONFIG ?= '/usr/share/tomcat5/conf/Catalina/localhost/ce-cream.xml';

variable CATALINA_CE_CREAM_CONTENTS ?= {
  contents = '<Context path="/'+CREAM_CREAM_APP_NAME+'" docBase="'+CREAM_CREAM_APP_NAME+
                             '" privileged="true" antiResourceLocking="false" antiJARLocking="false">' + "\n";
  contents = contents + "\n";
  contents = contents + '        <Logger className="org.apache.catalina.logger.FileLogger"' + "\n";
  contents = contents + '                prefix="glite-test-"' + "\n";
  contents = contents + '                suffix=".log" />' + "\n";
  contents = contents + "\n";
  contents = contents + '        <Environment name="configuration_provider"' + "\n";
  contents = contents + '                     value="org.glite.ce.cream.configuration.basic.CREAMConfigContextFactory"' + "\n";
  contents = contents + '                     type="java.lang.String" override="false"/>' + "\n";
  contents = contents + "\n";
  contents = contents + '        <Environment name="configuration_provider_url"' + "\n";
  contents = contents + '                      value="/etc/glite-ce-cream/cream-config.xml"' + "\n";  
  contents = contents + '                      type="java.lang.String" override="false"/>' + "\n";
  contents = contents + "\n";
  contents = contents + '        <Environment name="log_configuration_file"' + "\n";
  contents = contents + '                     value="/etc/glite-ce-cream/log4j.properties"' + "\n";   
  contents = contents + '                     type="java.lang.String" override="false"/>' + "\n";
  contents = contents + "\n";
  contents = contents + '        <Resource name="jdbc/dlg"' + "\n";
  contents = contents + '            auth="Container"' + "\n";
  contents = contents + '            type="javax.sql.DataSource"' + "\n";
  contents = contents + '            factory="'+CREAM_DATA_SOURCE_FACTORY_CLASS+'"' + "\n";
  contents = contents + '            driverClassName="org.gjt.mm.mysql.Driver"' + "\n";
  contents = contents + '            username="' + CREAM_DB_USER + '" password="' + CREAM_DB_PASSWORD_XML + '"' + "\n";
  contents = contents + '            maxActive="500"' + "\n";
  contents = contents + '            maxIdle="30"' + "\n";
  contents = contents + '            maxWait="10000"' + "\n";
  contents = contents + '            logAbandoned="false" removeAbandoned="true" removeAbandonedTimeout="30"' + "\n";
  contents = contents + '            url="jdbc:mysql://'+CREAM_MYSQL_SERVER+':3306/'+DLG_DB_NAME+'?autoReconnect=true"' + "\n";
  contents = contents + '            validationQuery="SELECT 1"' + "\n";
  contents = contents + '            testOnBorrow="true"' + "\n";
  contents = contents + '            testWhileIdle="true"' + "\n";
  contents = contents + '            timeBetweenEvictionRunsMillis="20000"' + "\n";
  contents = contents + '            minEvictableIdleTimeMillis="90000"/>' + "\n";
  contents = contents + "\n";
  contents = contents + '   <Resource name="jdbc/creamdb" ' + "\n";
  contents = contents + '            auth="Container"' + "\n";
  contents = contents + '            type="javax.sql.DataSource"' + "\n";
  contents = contents + '            factory="'+CREAM_DATA_SOURCE_FACTORY_CLASS+'"' + "\n";
  contents = contents + '            driverClassName="org.gjt.mm.mysql.Driver"' + "\n";
  ...
  contents = contents + '            maxIdle="30"' + "\n";
  contents = contents + '            maxWait="10000"' + "\n";
  contents = contents + '            url="jdbc:mysql://'+CREAM_MYSQL_SERVER+':3306/'+CREAM_DB_NAME+'"' + "\n";
  contents = contents + '            validationQuery="SELECT 1"' + "\n";
  contents = contents + '            testOnBorrow="true"' + "\n";
  contents = contents + '            testWhileIdle="true"' + "\n";
  contents = contents + '            timeBetweenEvictionRunsMillis="20000"' + "\n";
  contents = contents + '            minEvictableIdleTimeMillis="90000"' + "\n";
  contents = contents + '            removeAbandoned="true"' + "\n";
  contents = contents + '            removeAbandonedTimeout="30"/>' + "\n";
...
"/software/components/filecopy/services" = {
    if (is_string(CATALINA_CE_CREAM_CONFIG) && is_string(CATALINA_CE_CREAM_CONTENTS)) {
        npush(escape(CATALINA_CE_CREAM_CONFIG),
            nlist("config",CATALINA_CE_CREAM_CONTENTS,
                "owner",TOMCAT_USER+':'+TOMCAT_GROUP,
                "perms","0600",
...
variable CREAM_TRUSTMANAGER_LOG4J_CONF = {
  root_logger = create('common/tomcat5/root-logger');
  app_logger = create('glite/cream_ce/trustmanager-logger');
...
variable CREAM_CREAM_LOG4J_CONF = {
  root_logger = create('common/tomcat5/root-logger');
  app_logger = create('glite/cream_ce/ce-cream-logger');
  app_logger['conf'] = replace('%%LOGFILE%%',
...
#------------------------------------------------------------------------------
variable CREAM_DAILY_RESTART ?= true;
