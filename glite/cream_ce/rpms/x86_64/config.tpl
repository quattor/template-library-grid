...
"/software/packages"=pkg_repl("emi-version","2.0.0-1.sl5","x86_64");
...
"/software/packages"=pkg_repl("glite-jdl-api-java","3.2.0-3.sl5","noarch");
"/software/packages"=pkg_repl("glite-info-provider-service", "1.8.1-2.el5", "noarch");
...
"/software/packages"=pkg_repl("glite-lb-logger","2.3.4-2.el5","x86_64");
...
"/software/packages"=pkg_repl("glite-lbjp-common-log","1.2.0-5.el5","x86_64");
...
"/software/packages"=pkg_repl("lcas-interface","1.3.18-2.el5","x86_64");
...
"/software/packages"=pkg_repl("lcas-plugins-check-executable","1.2.4-1.el5","x86_64");
"/software/packages"=pkg_repl("lcas-plugins-voms","1.3.10-1.el5","x86_64");
"/software/packages"=pkg_repl("lcmaps","1.5.5-1.el5","x86_64");
"/software/packages"=pkg_repl("lcmaps-plugins-basic","1.5.0-3.sl5","x86_64");
...
"/software/packages"=pkg_repl("lcmaps-plugins-c-pep","1.2.2-1.el5","x86_64");
...
#GLEXEC/ARGUS
"/software/packages"=pkg_repl("glexec","0.9.6-1.el5","x86_64");
...
#BDII
"/software/packages"=pkg_repl("bdii", "5.2.10-1.el5", "noarch");
"/software/packages"=pkg_repl("glue-schema", "2.0.8-1.el5", "noarch");
...
"/software/packages"=pkg_repl("gridsite-libs","1.7.21-3.el5","x86_64");
...
"/software/packages"=pkg_repl("dynsched-generic","2.4.1-1.sl5","noarch");
...
'/software/packages' = {
  if ( EMI_UPDATE_VERSION >= '08' ) {
    # From EPEL
    pkg_repl('glite-ce-wsdl','1.14.0-4.sl5','noarch', '', '', 'emi');
  };
  SELF;
};
