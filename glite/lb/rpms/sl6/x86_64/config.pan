unique template glite/lb/rpms/sl6/x86_64/config;
...
'/software/packages'=pkg_repl('emi-version','3.5.2-1.el6','x86_64');
...
'/software/packages'=pkg_repl('glite-lb-types','2.0.7-2.el6','noarch'); 
...
'/software/packages'=pkg_repl('log4c','1.2.4-1.el6','x86_64');
