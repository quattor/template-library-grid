...
'/software/packages' = pkg_repl('bdii', '3.9.1-5', 'noarch');
...
'/software/packages' = pkg_repl('glite-yaim-core', '4.0.4-2', 'noarch');
'/software/packages' = pkg_repl('glite-yaim-lb', '4.0.1-3', 'noarch');
'/software/packages' = pkg_repl('glue-schema', '1.3.0-3', 'noarch');
...
'/software/packages'= if ( GLITE_UPDATE_VERSION >= '32' ) {
                        pkg_repl('glite-info-provider-service','1.0.0-4', 'noarch');
                      } else {
                        SELF;
                      };
