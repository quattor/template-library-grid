...
# superusers file is deprecated. Replaced by ADMIN_ACCESS section in glite-lb-authz.conf
#variable LB_SUPER_USERS_FILE ?= GLITE_LOCATION + '/etc/LB-super-users';
variable LB_AUTHZ_FILE ?= EMI_LOCATION + '/etc/glite-lb/glite-lb-authz.conf';
