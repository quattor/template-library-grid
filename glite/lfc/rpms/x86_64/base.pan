...
'/software/packages' = pkg_repl("lfc-yaim","4.2.6-1.el5","noarch");
'/software/packages' = pkg_repl('lcgdm-libs',"1.8.6-1.el5",'x86_64');
'/software/packages' = pkg_repl('lcgdm-devel',"1.8.6-1.el5",'x86_64');
'/software/packages' = pkg_repl("lcgdm-dav","0.11.0-2.el5","x86_64");
'/software/packages' = pkg_repl("lcgdm-dav-libs","0.11.0-2.el5","x86_64");
'/software/packages' = pkg_repl("lcgdm-dav-server","0.11.0-2.el5","x86_64");
'/software/packages' = pkg_repl('lfc',"1.8.6-1.el5",'x86_64');
'/software/packages' = pkg_repl("lfc-dli","1.8.6-1.el5","x86_64");
...
'/software/packages'= {
  if ( EMI_UPDATE_VERSION >= '08' ) {
    ...
    pkg_repl('dmlite-plugins-adapter','0.4.1-1.el5','x86_64');
    pkg_repl('dmlite-plugins-mysql','0.4.1-1.el5','x86_64');
    pkg_repl('gridsite',     '2.0.4-1.el5','x86_64');
