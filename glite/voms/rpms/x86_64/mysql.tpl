...
"/software/packages"= {
  ...
  pkg_repl('voms-admin-server',           '2.7.0-1.el5', 'noarch');
  pkg_repl('voms-admin-client',           '2.0.17-1.el5','noarch');
  pkg_repl('glite-info-provider-service', '1.8.1-2.el5', 'noarch');
  pkg_repl('voms-server',                 '2.0.8-1.el5', 'x86_64');
  pkg_repl('voms-mysql-plugin',           '3.1.6-1.el5', 'x86_64');
  pkg_repl('bdii',                        '5.2.10-1.el5','noarch');
  pkg_repl('glue-schema',                 '2.0.8-1.el5', 'noarch');
  pkg_repl('glite-yaim-bdii',             '4.3.9-1.el5', 'noarch');
  ...
  pkg_repl('glite-yaim-core',             '5.1.0-1.sl5', 'noarch');
  SELF;
};
