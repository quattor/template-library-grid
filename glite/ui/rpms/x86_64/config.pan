unique template glite/ui/rpms/x86_64/config;
...
# EMI UI
'/software/packages' = pkg_repl('emi-ui',     '2.0.1-1.el5','x86_64');
'/software/packages' = pkg_repl('emi-version','2.5.0-1.sl5','x86_64');
...
# DPM Client #
##############
'/software/packages' = pkg_repl('dpm',         '1.8.4-1.el5', 'x86_64');
'/software/packages' = pkg_repl('dpm-libs',    '1.8.4-1.el5', 'x86_64');
'/software/packages' = pkg_repl('dpm-devel',   '1.8.4-1.el5', 'x86_64');
'/software/packages' = pkg_repl('lcgdm-libs',  '1.8.4-1.el5', 'x86_64');
'/software/packages' = pkg_repl('lcgdm-devel', '1.8.4-1.el5', 'x86_64');
'/software/packages' = pkg_repl('dpm-perl',    '1.8.4-1.el5', 'x86_64');
'/software/packages' = pkg_repl('dpm-python',  '1.8.4-1.el5', 'x86_64');
'/software/packages' = pkg_repl('dpm-python26','1.8.4-1.el5', 'x86_64');
'/software/packages' = pkg_repl('dpm-libs',    '1.8.4-1.el5', 'i386');
'/software/packages' = pkg_repl('lcgdm-libs',  '1.8.4-1.el5', 'i386');
'/software/packages' = pkg_repl('lcgdm-devel', '1.8.4-1.el5', 'i386');

##############
# LFC Client #
##############
'/software/packages' = pkg_repl('lfc',         '1.8.4-1.el5', 'x86_64');
'/software/packages' = pkg_repl('lfc-libs',    '1.8.4-1.el5', 'x86_64');
'/software/packages' = pkg_repl('lfc-devel',   '1.8.4-1.el5', 'x86_64');
'/software/packages' = pkg_repl('lfc-perl',    '1.8.4-1.el5', 'x86_64');
'/software/packages' = pkg_repl('lfc-python',  '1.8.4-1.el5', 'x86_64');
'/software/packages' = pkg_repl('lfc-python26','1.8.4-1.el5', 'x86_64');
'/software/packages' = pkg_repl('lfc-libs',    '1.8.4-1.el5', 'i386');

########
# GFal #
########
'/software/packages' = pkg_repl('gfal',         '1.12.1-1.el5','x86_64');
'/software/packages' = pkg_repl('gfal',         '1.12.1-1.el5','i386');
'/software/packages' = pkg_repl('gfal-doc',     '1.12.1-1.el5','x86_64');
'/software/packages' = pkg_repl('gfal-python',  '1.12.1-1.el5','x86_64');
'/software/packages' = pkg_repl('gfal-python26','1.12.1-1.el5','x86_64');

'/software/packages' = pkg_repl('gfal2-all',           '2.0.0-0.6.beta.el5','x86_64');
'/software/packages' = pkg_repl('gfal2-python',        '1.0.0-5beta1',      'x86_64');
'/software/packages' = pkg_repl('gfal2-core',          '2.0.0-0.6.beta.el5','x86_64');
'/software/packages' = pkg_repl('gfal2-plugin-dcap',   '2.0.0-0.6.beta.el5','x86_64');
'/software/packages' = pkg_repl('gfal2-plugin-gridftp','2.0.0-0.6.beta.el5','x86_64');
'/software/packages' = pkg_repl('gfal2-plugin-lfc',    '2.0.0-0.6.beta.el5','x86_64');
'/software/packages' = pkg_repl('gfal2-plugin-rfio',   '2.0.0-0.6.beta.el5','x86_64');
'/software/packages' = pkg_repl('gfal2-plugin-srm',    '2.0.0-0.6.beta.el5','x86_64');
'/software/packages' = pkg_repl('gfal2-transfer',      '2.0.0-0.6.beta.el5','x86_64');

'/software/packages' = pkg_repl('gfalFS','1.0.0-2beta1.el5','x86_64');

#################
# dCache Client #
#################
'/software/packages' = pkg_repl('dcache-srmclient', '2.1.1-1.el5', 'x86_64');

################
# Storm Client #
################
'/software/packages' = pkg_repl('storm-srm-client','1.6.0-6.sl5','x86_64');
'/software/packages' = pkg_repl('emi.amga.amga-cli', '2.3.0-1.sl5', 'x86_64');

###############
# VOMS Client #
###############
'/software/packages' = pkg_repl('voms',         '2.0.8-1.el5','x86_64');
'/software/packages' = pkg_repl('voms',         '2.0.8-1.el5','i386');
...
# WMS Client #
##############
'/software/packages' = pkg_repl('glite-lb-client',                '5.1.4-2.el5','x86_64');
'/software/packages' = pkg_repl('glite-lbjp-common-trio',         '2.2.2-3.el5','x86_64');
'/software/packages' = pkg_repl('glite-service-discovery-api-c',  '2.2.3-1.sl5','x86_64');
'/software/packages' = pkg_repl('glite-wms-ui-commands',          '3.4.0-4.sl5','x86_64');
'/software/packages' = pkg_repl('glite-wms-ui-api-python',        '3.4.0-5.sl5','x86_64');
'/software/packages' = pkg_repl('glite-wms-utils-exception',      '3.3.0-2.sl5','x86_64');
'/software/packages' = pkg_repl('glite-wms-wmproxy-api-cpp',      '3.4.0-4.sl5','x86_64');
...
'/software/packages' = pkg_repl('glite-wms-brokerinfo-access-lib','3.4.0-4.sl5','x86_64');
'/software/packages' = pkg_repl('glite-wms-brokerinfo-access',    '3.4.0-4.sl5','x86_64');
'/software/packages' = pkg_repl('glite-wms-utils-classad',        '3.3.0-2.sl5','x86_64');
'/software/packages' = pkg_repl('glite-lb-client-progs',          '5.1.4-2.el5','x86_64');
'/software/packages' = pkg_repl('glite-lb-common',                '8.1.3-3.el5','x86_64');
'/software/packages' = pkg_repl('glite-lbjp-common-gsoap-plugin', '3.1.2-2.el5','x86_64');
'/software/packages' = pkg_repl('glite-lbjp-common-gss',          '3.1.3-2.el5','x86_64');
'/software/packages' = pkg_repl('glite-jdl-api-cpp',              '3.3.0-3.sl5','x86_64');
'/software/packages' = pkg_repl('glite-jobid-api-c',              '2.1.2-2.el5','x86_64');
...
# dcap #
########
'/software/packages' = pkg_repl('dcap',              '2.47.6-1.el5','x86_64');
'/software/packages' = pkg_repl('dcap-libs',         '2.47.6-1.el5','x86_64');
'/software/packages' = pkg_repl('dcap-devel',        '2.47.6-1.el5','x86_64');
'/software/packages' = pkg_repl('dcap-tunnel-telnet','2.47.6-1.el5','x86_64');
'/software/packages' = pkg_repl('dcap-tunnel-ssl',   '2.47.6-1.el5','x86_64');
'/software/packages' = pkg_repl('dcap-tunnel-krb',   '2.47.6-1.el5','x86_64');
'/software/packages' = pkg_repl('dcap-tunnel-gsi',   '2.47.6-1.el5','x86_64');
...
# CREAM Client #
################
'/software/packages' = pkg_repl('glite-ce-cream-client-api-c',  '1.14.0-4.sl5','x86_64');
'/software/packages' = pkg_repl('glite-ce-monitor-client-api-c','1.14.0-4.sl5','x86_64');
'/software/packages' = pkg_repl('glite-ce-cream-cli',           '1.14.0-4.sl5','x86_64');

########
# Yaim #
########
'/software/packages' = pkg_repl('glite-yaim-clients','5.0.1-2.sl5', 'noarch');
'/software/packages' = pkg_repl('glite-yaim-core',   '5.1.0-1.sl5', 'noarch');

############
# Gridsite #
############
'/software/packages' = pkg_repl('gridsite-commands', '1.7.21-2.el5','x86_64');
#'/software/packages' = pkg_repl('gridsite-libs',     '1.7.21-2.el5','i386');
'/software/packages' = pkg_repl('gridsite-libs',     '1.7.21-2.el5','x86_64');
...
'/software/packages' = pkg_repl('lcg-util',         '1.12.0-6.el5','x86_64');
'/software/packages' = pkg_repl('lcg-util-libs',    '1.12.0-6.el5','x86_64');
'/software/packages' = pkg_repl('lcg-util-libs',    '1.12.0-6.el5','i386');
'/software/packages' = pkg_repl('lcg-util-python26','1.12.0-6.el5','x86_64');
'/software/packages' = pkg_repl('lcg-util-python',  '1.12.0-6.el5','x86_64');
...
'/software/packages' = pkg_repl('unicore-hila-unicore6','2.3.0-4',    'noarch');
'/software/packages' = pkg_repl('unicore-hila-shell',   '2.3.0-4',    'noarch');
'/software/packages' = pkg_repl('unicore-ucc6',         '5.0.0-1.sl5','noarch');

#############
# Nordugrid #
#############
'/software/packages' = pkg_repl('nordugrid-arc',               '2.0.1-1.el5','x86_64');
'/software/packages' = pkg_repl('nordugrid-arc-client',        '2.0.1-1.el5','x86_64');
'/software/packages' = pkg_repl('nordugrid-arc-compat',        '1.0.1-1.el5','x86_64');
'/software/packages' = pkg_repl('nordugrid-arc-java',          '2.0.1-1.el5','x86_64');
'/software/packages' = pkg_repl('nordugrid-arc-plugins-globus','2.0.1-1.el5','x86_64');
'/software/packages' = pkg_repl('nordugrid-arc-plugins-needed','2.0.1-1.el5','x86_64');
'/software/packages' = pkg_repl('nordugrid-arc-python',        '2.0.1-1.el5','x86_64');
...
'/software/packages' = pkg_repl('gridftp-ifce',           '2.1.4-2.el5',     'x86_64');
'/software/packages' = pkg_repl('gridftp-ifce',           '2.1.4-2.el5',     'i386');
'/software/packages' = pkg_repl('srm-ifce',               '1.12.3-1.el5',    'x86_64');
'/software/packages' = pkg_repl('srm-ifce',               '1.12.3-1.el5',    'i386');
'/software/packages' = pkg_repl('is-interface',           '1.12.2-2.el5',    'x86_64');
'/software/packages' = pkg_repl('is-interface',           '1.12.2-2.el5',    'i386');
...
###############################
'/software/packages' = pkg_repl('ca_policy_igtf-classic','1.52-1','noarch');
'/software/packages' = pkg_repl('ca_policy_igtf-mics',   '1.52-1','noarch');
'/software/packages' = pkg_repl('ca_policy_igtf-slcs',   '1.52-1','noarch');
