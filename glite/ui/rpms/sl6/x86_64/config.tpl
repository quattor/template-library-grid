...
# EMI UI
"/software/packages"=pkg_repl("emi-ui","2.0.1-1.el6","x86_64");
"/software/packages"=pkg_repl("emi-version","2.6.1-1.sl6","x86_64");
...
"/software/packages"=pkg_repl("gfal-doc","1.14.0-1.el6","x86_64");
"/software/packages"=pkg_repl("gfal-python","1.14.0-1.el6","x86_64");

"/software/packages"=pkg_repl("gfal2-all","2.1.0-2.el6","x86_64");
"/software/packages"=pkg_repl("gfal2-python","1.1.0-0.el6","x86_64");
"/software/packages"=pkg_repl("gfal2-core","2.1.0-2.el6","x86_64");
"/software/packages"=pkg_repl("gfal2-plugin-dcap","2.1.0-2.el6","x86_64");
"/software/packages"=pkg_repl("gfal2-plugin-gridftp","2.1.0-2.el6","x86_64");
"/software/packages"=pkg_repl("gfal2-plugin-lfc","2.1.0-2.el6","x86_64");
"/software/packages"=pkg_repl("gfal2-plugin-rfio","2.1.0-2.el6","x86_64");
"/software/packages"=pkg_repl("gfal2-plugin-srm","2.1.0-2.el6","x86_64");
"/software/packages"=pkg_repl("gfal2-transfer","2.1.0-2.el6","x86_64");
...
# Storm Client #
################
"/software/packages"=pkg_repl("storm-srm-client","1.6.0-6.sl6","x86_64");
...
'/software/packages' = pkg_repl('voms-api-java','2.0.8-1.el6', "noarch"); #no
...
"/software/packages"=pkg_repl("globus-rls-client","5.2-6.el6","x86_64");
...
"/software/packages"=pkg_repl("globus-gssapi-gsi","10.7-1.el6","x86_64");#GLOBUS stuff
"/software/packages"=pkg_repl("globus-xio-gsi-driver","2.3-1.el6","i686");#GLOBUS stuff
"/software/packages"=pkg_repl("globus-xio-popen-driver","2.3-1.el6","i686");#GLOBUS stuff
...
# WMS Client #
##############
"/software/packages"=pkg_repl("glite-lb-client","5.1.6-1.el6","x86_64");
"/software/packages"=pkg_repl("glite-lbjp-common-trio","2.2.3-2.el6","x86_64");
"/software/packages"=pkg_repl("glite-service-discovery-api-c","2.2.3-1.sl6","x86_64");
"/software/packages"=pkg_repl("glite-wms-ui-commands","3.4.0-5.sl6","x86_64");
"/software/packages"=pkg_repl("glite-wms-ui-api-python","3.4.0-5.sl6","x86_64");
"/software/packages"=pkg_repl("glite-wms-utils-exception","3.3.0-2.sl6","x86_64");
"/software/packages"=pkg_repl("glite-wms-wmproxy-api-cpp","3.4.0-4.sl6","x86_64");
"/software/packages"=pkg_repl("glite-wms-wmproxy-api-python","3.4.0-4.sl6","noarch");
"/software/packages"=pkg_repl("glite-wms-wmproxy-api-java","3.4.0-4.sl6","noarch");
...
"/software/packages"=pkg_repl("glite-wms-utils-classad","3.3.0-2.sl6","x86_64");
"/software/packages"=pkg_repl("glite-lb-client-progs","5.1.6-1.el6","x86_64");
"/software/packages"=pkg_repl("glite-lb-common","8.1.5-1.el6","x86_64");
"/software/packages"=pkg_repl("glite-lbjp-common-gsoap-plugin","3.1.3-1.el6","x86_64");
"/software/packages"=pkg_repl("glite-lbjp-common-gss","3.1.6-1.el6","x86_64");
"/software/packages"=pkg_repl("glite-jdl-api-cpp","3.3.0-3.sl6","x86_64");
"/software/packages"=pkg_repl("glite-jobid-api-c","2.1.2-5.el6","x86_64");
...
"/software/packages"=pkg_repl("dcap-tunnel-krb","2.47.7-1.el6","x86_64");
"/software/packages"=pkg_repl("dcap-tunnel-gsi","2.47.7-1.el6","x86_64");

##################
# EMI Delegation #
##################
"/software/packages"=pkg_repl("emi-delegation-java","2.2.0-2.sl6","noarch");
"/software/packages"=pkg_repl("delegation-cli","2.1.4-1.el6","x86_64");
"/software/packages"=pkg_repl("delegation-api-c","2.1.3-1.el6","x86_64");

################
# CREAM Client #
################
"/software/packages"=pkg_repl("glite-ce-cream-client-api-c","1.14.1-1.sl6","x86_64");
"/software/packages"=pkg_repl("glite-ce-monitor-client-api-c","1.14.1-1.sl6","x86_64");
"/software/packages"=pkg_repl("glite-ce-cream-cli","1.14.1-1.sl6","x86_64");

'/software/packages' = if ( EMI_UPDATE_VERSION >= '14' ) {
    # Some RPMs need to be deleted
    pkg_repl('glite-ce-monitor-cli', '1.14.1-1.sl6', 'x86_64');
} else {
    SELF;
};
...
# Gridsite #
############
"/software/packages"=pkg_repl("gridsite-commands","1.7.25-1.emi2.el6","x86_64");
#'/software/packages' = pkg_repl('gridsite-libs',     '1.7.21-2.el6','i386');
"/software/packages"=pkg_repl("gridsite-libs","1.7.25-1.emi2.el6","x86_64");
...
"/software/packages"=pkg_repl("lcg-util","1.14.0-0.el6","x86_64");
"/software/packages"=pkg_repl("lcg-util-libs","1.14.0-0.el6","x86_64");
"/software/packages"=pkg_repl("lcg-util-libs","1.14.0-0.el6","i386");
"/software/packages"=pkg_repl("lcg-util-python","1.14.0-0.el6","x86_64");
...
"/software/packages"=pkg_repl("unicore-hila-unicore6","2.3.0-5.sl6","noarch");
"/software/packages"=pkg_repl("unicore-hila-shell","2.3.0-5.sl6","noarch");
"/software/packages"=pkg_repl("unicore-ucc6","5.0.0-1.sl6","noarch");

#############
# Nordugrid #
#############
"/software/packages"=pkg_repl("nordugrid-arc","2.0.1-1.el6","x86_64");
"/software/packages"=pkg_repl("nordugrid-arc-client","2.0.1-1.el6","x86_64");
"/software/packages"=pkg_repl("nordugrid-arc-compat","1.0.1-1.el6","x86_64");
"/software/packages"=pkg_repl("nordugrid-arc-java","2.0.1-1.el6","x86_64");
"/software/packages"=pkg_repl("nordugrid-arc-plugins-globus","2.0.1-1.el6","x86_64");
"/software/packages"=pkg_repl("nordugrid-arc-plugins-needed","2.0.1-1.el6","x86_64");
"/software/packages"=pkg_repl("nordugrid-arc-python","2.0.1-1.el6","x86_64");

# XROOTD
"/software/packages"=pkg_repl("xrootd-libs","3.0.5-1.el6","x86_64");

'/software/packages' =  {
                 pkg_repl("emi.saga-adapter.context-cpp","1.0.2-3.sl6","x86_64");
                 pkg_repl("emi.saga-adapter.sd-cpp","1.0.4-1.sl6","x86_64");
                 pkg_repl("emi.saga-adapter.isn-cpp","1.0.3-1.sl6","x86_64");
                 pkg_repl("emi.saga-adapter.isn-common","1.0.1-3.sl6","noarch");
                 pkg_repl("SAGA.lsu-cpp.engine","1.6.0-1.sl6","x86_64");
};

"/software/packages"=pkg_repl("emi-trustmanager","3.1.4-1.sl6","noarch");
"/software/packages"=pkg_repl("emi-trustmanager-tomcat","3.0.1-1.sl6","noarch");
"/software/packages"=pkg_repl("emi-trustmanager-axis","2.0.2-1.sl6","noarch");

"/software/packages"=pkg_repl("gridftp-ifce","2.3.0-0.el6","x86_64");
"/software/packages"=pkg_repl("gridftp-ifce","2.3.0-0.el6","i386");
"/software/packages"=pkg_repl("srm-ifce","1.14.0-1.el6","x86_64");
"/software/packages"=pkg_repl("srm-ifce","1.14.0-1.el6","i386");
"/software/packages"=pkg_repl("is-interface","1.14.0-0.el6","x86_64");
"/software/packages"=pkg_repl("is-interface","1.14.0-0.el6","i386");
"/software/packages"=pkg_repl("transfer-cli","4.0.3-1.el6","x86_64");
'/software/packages' = pkg_repl('util-c',                 '1.3.2-1_HEAD.el6','x86_64'); #no
