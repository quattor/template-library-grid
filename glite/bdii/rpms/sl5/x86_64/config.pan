...
'/software/packages' = pkg_repl('glite-yaim-core', '5.1.1-1.el5', 'noarch');
...
'/software/packages' = {
    if (BDII_TYPE == 'top' || BDII_TYPE == 'site' || BDII_TYPE == 'combined') {
        pkg_repl('bdii', '5.2.12-1.el5', 'noarch');
        pkg_repl('emi-resource-information-service', '1.0.3-1.el5', 'noarch');
        pkg_repl('emi-version', '3.0.0-1.el5', 'x86_64');
    ...
    if (BDII_TYPE == 'site' || BDII_TYPE == 'combined') {
        ...
        pkg_repl('emi-bdii-site', '1.0.0-1.el5', 'noarch');
    ...
    if (BDII_TYPE == 'top') {
        ...
        pkg_repl('emi-bdii-top', '1.0.1-2.el5', 'noarch');
