...
'/software/packages'=pkg_repl('dpm-yaim', '4.2.9-1.el5', 'noarch');
"/software/packages"=pkg_repl("emi-version","3.0.0-1.sl5",PKG_ARCH_GLITE);
...
"/software/packages"=pkg_repl("voms-devel","2.0.10-1.el5",PKG_ARCH_GLITE);
