...
'/software/packages'=pkg_repl('emi-lb','1.0.1-1.el5','x86_64');
...
'/software/packages'=pkg_repl('glite-jobid-api-c','2.1.2-5.el5','x86_64');
'/software/packages'=pkg_repl('glite-jobid-api-java','1.2.0-7.el5','noarch');
'/software/packages'=pkg_repl('glite-lb-client','5.1.6-1.el5','x86_64');
'/software/packages'=pkg_repl('glite-lb-client-java','1.2.3-2.el5','x86_64');
'/software/packages'=pkg_repl('glite-lb-client-progs','5.1.6-1.el5','x86_64');
'/software/packages'=pkg_repl('glite-lb-common','8.1.5-1.el5','x86_64');
'/software/packages'=pkg_repl('glite-lb-doc','1.3.6-1.el5','noarch');
'/software/packages'=pkg_repl('glite-lb-harvester','1.2.4-1.el5','x86_64');
'/software/packages'=pkg_repl('glite-lbjp-common-db','3.1.3-2.el5','x86_64');
'/software/packages'=pkg_repl('glite-lbjp-common-gsoap-plugin','3.1.3-1.el5','x86_64');
'/software/packages'=pkg_repl('glite-lbjp-common-gss','3.1.6-1.el5','x86_64');
'/software/packages'=pkg_repl('glite-lbjp-common-jp-interface','2.2.1-4.el5','x86_64');
'/software/packages'=pkg_repl('glite-lbjp-common-log','1.2.1-1.el5','x86_64');
'/software/packages'=pkg_repl('glite-lbjp-common-maildir','2.2.1-6.el5','x86_64');
'/software/packages'=pkg_repl('glite-lbjp-common-server-bones','2.2.2-4.el5','x86_64');
'/software/packages'=pkg_repl('glite-lbjp-common-trio','2.2.3-2.el5','x86_64');
'/software/packages'=pkg_repl('glite-lb-logger','2.3.7-1.el5','x86_64');
'/software/packages'=pkg_repl('glite-lb-logger-msg','1.1.5-1.el5','x86_64');
'/software/packages'=pkg_repl('glite-lb-server','2.3.8-1.el5','x86_64');
'/software/packages'=pkg_repl('glite-lb-state-machine','1.3.4-1.el5','x86_64');
'/software/packages'=pkg_repl('glite-lb-utils','2.2.3-1.el5','x86_64');
'/software/packages'=pkg_repl('glite-lb-ws-interface','3.3.1-6.el5','noarch');
'/software/packages'=pkg_repl('glite-lb-ws-test','1.3.2-1.el5','x86_64');
'/software/packages'=pkg_repl('glite-lb-yaim','4.4.4-1.el5','noarch');
'/software/packages'=pkg_repl('glite-px-proxyrenewal','1.3.25-5.el5','x86_64');
'/software/packages'=pkg_repl('glite-px-proxyrenewal-devel','1.3.25-5.el5','x86_64');
'/software/packages'=pkg_repl('glite-px-proxyrenewal-libs','1.3.25-5.el5','x86_64');
'/software/packages'=pkg_repl('glite-px-proxyrenewal-progs','1.3.25-5.el5','x86_64');
...
'/software/packages'=pkg_repl('glite-wms-common','3.4.0-5.sl5','x86_64');
...
'/software/packages'=pkg_repl('glite-wms-ice','3.4.0-7.sl5','x86_64');
'/software/packages'=pkg_repl('glite-wms-ism','3.4.0-7.sl5','x86_64');
'/software/packages'=pkg_repl('glite-wms-jobsubmission','3.4.0-9.sl5','x86_64');
'/software/packages'=pkg_repl('glite-wms-jobsubmission-lib','3.4.0-9.sl5','x86_64');
...
'/software/packages'=pkg_repl('glite-wms-purger','3.4.0-4.sl5','x86_64');
...
'/software/packages'=pkg_repl('lcmaps-without-gsi','1.5.5-1.el5','x86_64');
...
'/software/packages'=pkg_repl('gridsite','1.7.22-2.el5','x86_64');
'/software/packages'=pkg_repl('gridsite-libs','1.7.22-2.el5','x86_64');
