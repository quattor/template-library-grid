...
#-----------------------------------------------------------------------------
# WMS Logrotate Configuration
#-----------------------------------------------------------------------------

include { 'components/altlogrotate/config' };

"/software/components/altlogrotate/entries/httpd_access" =
  nlist("pattern", WMS_LOCATION_LOG + "/httpd-wmproxy-access.log",
        "compress", true,
        "frequency", "daily",
        "delaycompress", true,
        "missingok", true,
...
"/software/components/altlogrotate/entries/httpd_errors" =
  nlist("pattern", WMS_LOCATION_LOG + "/httpd-wmproxy-errors.log",
        "compress", true,
        "frequency", "daily",
        "delaycompress", true,
        "missingok", true,
...
"/software/components/altlogrotate/entries/ice" =
  nlist("pattern", WMS_LOCATION_LOG + "/ice.log",
        "compress", true,
        "frequency", "daily",
        "delaycompress", true,
        "missingok", true,
...
"/software/components/altlogrotate/entries/jc" =
  nlist("pattern", WMS_LOCATION_LOG + "/jobcontroller_events.log",
        "compress", true,
        "frequency", "daily",
        "delaycompress", true,
        "missingok", true,
...
"/software/components/altlogrotate/entries/lcmaps" =
  nlist("pattern", WMS_LOCATION_LOG + "/lcmaps.log",
        "compress", true,
        "frequency", "daily",
        "delaycompress", true,
        "missingok", true,
...
"/software/components/altlogrotate/entries/lm" =
  nlist("pattern", WMS_LOCATION_LOG + "/logmonitor_events.log",
        "compress", true,
        "frequency", "daily",
        "delaycompress", true,
        "missingok", true,
...
"/software/components/altlogrotate/entries/wm" =
  nlist("pattern", WMS_LOCATION_LOG + "/workload_manager_events.log",
        "compress", true,
        "frequency", "daily",
        "delaycompress", true,
        "missingok", true,
...
"/software/components/altlogrotate/entries/wmproxy" =
  nlist("pattern", WMS_LOCATION_LOG + "/wmproxy_events.log",
        "compress", true,
        "frequency", "daily",
        "delaycompress", true,
        "missingok", true,
