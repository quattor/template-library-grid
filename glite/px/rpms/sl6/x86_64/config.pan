unique template glite/px/rpms/sl6/x86_64/config;

# EMI packages
'/software/packages' = pkg_repl('emi-px', '1.0.1-1.el6', 'x86_64');
'/software/packages' = pkg_repl('bdii', '5.2.12-1.el6', 'noarch');
'/software/packages' = pkg_repl('emi-version', '2.7.1-1.sl6', 'x86_64');
'/software/packages' = pkg_repl('glite-info-provider-service', '1.9.0-5.el6', 'noarch');
'/software/packages' = pkg_repl('glite-px-myproxy-yaim', '4.1.7-1.el6', 'noarch');
...
'/software/packages' = pkg_repl('fetch-crl', '3.0.8-1.el6', 'noarch');
'/software/packages' = pkg_repl('myproxy', '5.9-2.el6', 'x86_64');
'/software/packages' = pkg_repl('myproxy-admin', '5.9-2.el6', 'x86_64');
'/software/packages' = pkg_repl('myproxy-libs', '5.9-2.el6', 'x86_64');
'/software/packages' = pkg_repl('myproxy-server', '5.9-2.el6', 'x86_64');
