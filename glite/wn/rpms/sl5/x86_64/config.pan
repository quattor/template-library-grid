unique template glite/wn/rpms/sl5/x86_64/config;
...
#EMI WN
"/software/packages"=pkg_repl("emi-wn","3.0.0-1.el5","x86_64");

"/software/packages"=pkg_repl("emi-version","3.0.0-1.sl5","x86_64");
"/software/packages"=pkg_repl("emi.amga.amga-cli","2.4.0-1.sl5","x86_64");

#SAGA STUFF
"/software/packages"=pkg_repl("emi.saga-adapter.context-cpp","1.0.2-3.sl5","x86_64");
"/software/packages"=pkg_repl("emi.saga-adapter.isn-common","1.0.1-3.sl5","noarch");
"/software/packages"=pkg_repl("emi.saga-adapter.sd-cpp","1.0.4-1.sl5","x86_64");
"/software/packages"=pkg_repl("emi.saga-adapter.isn-cpp","1.0.3-1.sl5","x86_64");
"/software/packages"=pkg_repl("SAGA.lsu-cpp.engine","1.6.0-1.sl5","x86_64");
...
#GRID STUFF
"/software/packages"=pkg_repl("a1_grid_env","3.0.2-1.sl5","x86_64");
...
'/software/packages'=pkg_repl('c-check','0.9.8-1.sl5','x86_64');
...
"/software/packages"=pkg_repl("gfal2","2.1.0-2.el5","x86_64");
...
"/software/packages"=pkg_repl("vomsjapi","2.0.6-2.el5","x86_64");
"/software/packages"=pkg_repl("voms-clients","2.0.10-1.el5","x86_64");
"/software/packages"=pkg_repl("voms-devel","2.0.10-1.el5","x86_64");
"/software/packages"=pkg_repl("voms","2.0.10-1.el5","i386");

#PBS STUFF
"/software/packages"=pkg_repl("lcg-pbs-utils","2.0.0-1.sl5","x86_64");
...
"/software/packages"=pkg_repl("glite-wn-info","1.0.3-2.sl5","noarch");
...
"/software/packages"=pkg_repl("globus-xio-gsi-driver","2.3-1.el5","i386");
...
#TORQUE
#"/software/packages"=pkg_repl("torque","2.5.7-7.el5","x86_64");
#"/software/packages"=pkg_repl("torque-client","2.5.7-7.el5","x86_64");
#"/software/packages"=pkg_repl("torque-mom","2.5.7-7.el5","x86_64");
#"/software/packages"=pkg_repl("libtorque","2.5.7-7.el5","x86_64");

#TRANSFER
"/software/packages"=pkg_repl("transfer-interface","3.7.2-1.el5","noarch");
#"/software/packages"=pkg_repl("transfer-cli","4.0.3-1.el5","x86_64"); #ANDREA: depends on gridsite-shared which is not available

#MUNGE
"/software/packages"=pkg_repl("munge","0.5.8-8.el5","x86_64");
"/software/packages"=pkg_repl("munge-libs","0.5.8-8.el5","x86_64");



#OTHERS (TO_BE_FIXED: some are to be doublechecked strange)
"/software/packages"=pkg_repl("c-ares","1.6.0-2.el5","x86_64");
#"/software/packages"=pkg_repl("util-c","1.3.2-1_HEAD.el5","x86_64"); #ANDREA: depends on gridsite-shared which is not available
