...
template update/07/rpms_thirdparty_sl6_x86_64;
...
'/software/packages'=pkg_ronly('globus-gridftp-server','6.14-1.el6','i686', '', '', 'emi');
'/software/packages'=pkg_ronly('globus-gridftp-server','6.14-1.el6','x86_64', '', '', 'emi');
...
'/software/packages'=pkg_ronly('globus-gridftp-server-devel','6.14-1.el6','i686', '', '', 'emi');
'/software/packages'=pkg_ronly('globus-gridftp-server-devel','6.14-1.el6','x86_64', '', '', 'emi');
'/software/packages'=pkg_ronly('globus-gridftp-server-progs','6.14-1.el6','x86_64', '', '', 'emi');
...
'/software/packages'=pkg_ronly('jclassads','2.4.0-2.sl6','noarch', '', '', 'emi');
...
'/software/packages'=pkg_ronly('xrootd','3.2.5-1.el6','x86_64', '', '', 'emi');
'/software/packages'=pkg_ronly('xrootd-client','3.2.5-1.el6','x86_64', '', '', 'emi');
'/software/packages'=pkg_ronly('xrootd-client-admin-java','3.2.5-1.el6','x86_64', '', '', 'emi');
'/software/packages'=pkg_ronly('xrootd-client-admin-perl','3.0.5-1.el6','x86_64', '', '', 'emi');
'/software/packages'=pkg_ronly('xrootd-debuginfo','3.2.5-1.el6','x86_64', '', '', 'emi');
'/software/packages'=pkg_ronly('xrootd-devel','3.0.5-1.el6','i686', '', '', 'emi');
'/software/packages'=pkg_ronly('xrootd-devel','3.2.5-1.el6','x86_64', '', '', 'emi');
'/software/packages'=pkg_ronly('xrootd-doc','3.2.5-1.el6','noarch', '', '', 'emi');
'/software/packages'=pkg_ronly('xrootd-fuse','3.2.5-1.el6','x86_64', '', '', 'emi');
'/software/packages'=pkg_ronly('xrootd-libs','3.0.5-1.el6','i686', '', '', 'emi');
'/software/packages'=pkg_ronly('xrootd-libs','3.2.5-1.el6','x86_64', '', '', 'emi');
