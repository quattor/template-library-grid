...
template update/18/rpms_thirdparty_sl6_i386;
...
'/software/packages'=pkg_ronly('globus-ftp-control-debuginfo','4.4-1.el6','i686', '', '', 'emi');
...
'/software/packages'=pkg_ronly('globus-gridftp-server-control-debuginfo','2.7-1.el6','i686', '', '', 'emi');
'/software/packages'=pkg_ronly('globus-gridftp-server-control-devel','2.7-1.el6','i686', '', '', 'emi');
'/software/packages'=pkg_ronly('globus-gridftp-server-debuginfo','6.16-1.el6','i686', '', '', 'emi');
'/software/packages'=pkg_ronly('globus-gridftp-server-devel','6.16-1.el6','i686', '', '', 'emi');
'/software/packages'=pkg_ronly('globus-gridftp-server-progs','6.16-1.el6','i686', '', '', 'emi');
'/software/packages'=pkg_ronly('globus-gss-assist','8.6-1.el6','i686', '', '', 'emi');
'/software/packages'=pkg_ronly('globus-gss-assist-debuginfo','8.6-1.el6','i686', '', '', 'emi');
...
'/software/packages'=pkg_ronly('globus-gss-assist-progs','8.6-1.el6','i686', '', '', 'emi');
'/software/packages'=pkg_ronly('globus-io','9.3-1.el6','i686', '', '', 'emi');
'/software/packages'=pkg_ronly('globus-io-debuginfo','9.3-1.el6','i686', '', '', 'emi');
