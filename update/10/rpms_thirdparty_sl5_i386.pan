...
template update/10/rpms_thirdparty_sl5_i386;
...
'/software/packages'=pkg_ronly('bouncycastle146-mail','1.46-1.sl5','noarch', '', '', 'emi');
...
'/software/packages'=pkg_ronly('lcas-lcmaps-gt4-interface','0.2.6-1.el5','i386', '', '', 'emi');
'/software/packages'=pkg_ronly('libldap2.4_2','2.4.22-1.el5','i386', '', '', 'emi');
'/software/packages'=pkg_ronly('maui','3.3-4.el5','i386', '', '', 'emi');
'/software/packages'=pkg_ronly('maui-client','3.3-4.el5','i386', '', '', 'emi');
'/software/packages'=pkg_ronly('maui-debuginfo','3.3-4.el5','i386', '', '', 'emi');
'/software/packages'=pkg_ronly('maui-devel','3.3-4.el5','i386', '', '', 'emi');
'/software/packages'=pkg_ronly('maui-server','3.3-4.el5','i386', '', '', 'emi');
