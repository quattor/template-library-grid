...
variable VOMS_SERVER_DN ?= list(
    ...
    'vo.racf.bnl.gov',              nlist('subject', '/DC=org/DC=doegrids/OU=Services/CN=vo.racf.bnl.gov',
    ...
    'voms1.egee.cesnet.cz',         nlist('subject', '/DC=org/DC=terena/DC=tcs/C=CZ/O=CESNET/CN=voms1.egee.cesnet.cz',
                                          'issuer', '/C=NL/O=TERENA/CN=TERENA eScience SSL CA',
                                         ),
    'voms2.cnaf.infn.it',           nlist('subject', '/C=IT/O=INFN/OU=Host/L=CNAF/CN=voms2.cnaf.infn.it',
                                          'issuer', '/C=IT/O=INFN/CN=INFN CA',
                                         ),
    'voms2.grid.cesnet.cz',         nlist('subject', '/DC=org/DC=terena/DC=tcs/C=CZ/O=CESNET/CN=voms2.grid.cesnet.cz',
                                          'issuer', '/C=NL/O=TERENA/CN=TERENA eScience SSL CA',
                                         ),
