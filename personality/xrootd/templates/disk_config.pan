structure template personality/xrootd/templates/disk_config;
...
#sec.protocol /usr/$(xrdlibdir) gsi -crl:3 -key:/etc/grid-security/dpmmgr/dpmkey.pem -cert:/etc/grid-security/dpmmgr/dpmcert.pem -md:sha256:sha1 -ca:2 -gmapopt:10 -vomsat:0 -vomsfun:/usr/lib64/libXrdSecgsiVOMS.so
