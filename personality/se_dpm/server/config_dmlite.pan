...
variable DMLITE_MEMCACHE_POOLSIZE ?= {
...
'/software/components/filecopy/services' = {
    if (is_boolean(DMLITE_ENABLED) && DMLITE_ENABLED) {
        SELF[escape('/etc/dmlite.conf.d/mysql.conf')] = dict(
...
'/software/components/filecopy/services' = {
    if ( is_boolean(DMLITE_ENABLED) && DMLITE_ENABLED ) {
        SELF[escape('/etc/dmlite.conf.d/zmemcache.conf')] = dict(
